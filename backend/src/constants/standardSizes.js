/**
 * Standard size chart constants — SCRUM-33 (US-MEASURE-003).
 * All measurements in cm. Used as a starting point for customers who
 * don't know their exact measurements.
 * measurementType flag: 'standard' | 'custom' (stored on order/config).
 */

const STANDARD_SIZE_LABELS = ['XS', 'S', 'M', 'L', 'XL', 'XXL', '3XL'];
...
module.exports = { STANDARD_SIZE_LABELS, STANDARD_SIZES };
