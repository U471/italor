...
export const validateCheckout = jest.fn();
export const createOrder = jest.fn();
export const getOrder = jest.fn();
export const createPaymentIntent = jest.fn();
export const getMyOrders = jest.fn();
export const getOrderDetail = jest.fn();
export const createReview = jest.fn();
export const getMyReviews = jest.fn();
export const markReviewHelpful = jest.fn();
export const deleteReview = jest.fn();
export const adminGetStats = jest.fn();
export const adminGetOrders = jest.fn();
export const adminGetOrderDetail = jest.fn();
export const adminUpdateOrderStatus = jest.fn();
export const adminProcessRefund = jest.fn();
export default api;
